...
const URL_APPS_SCRIPT = https://script.google.com/macros/s/AKfycbyd1HYUPPGTw8cfCJz9WDGmeKUHi5nRCowY-oYkhKvCArNOuFhBt6dhE-qS9Zx13tsDHg/exec";
...
if (elemento) {
    ...
    elemento.textContent =
        equipo ? equipo : "Equipo no identificado";
...
preguntasActuales.forEach((textoPregunta, index) => {
    ...
    divPregunta.innerHTML = `
        ...
        <div class="opciones">
            ...
            <button
                type="button"
                onclick="seleccionar(this, ${num}, 'ok')"
            >
                OK
            </button>
            ...
            <button
                type="button"
                onclick="seleccionar(this, ${num}, 'nook')"
            >
                NO OK
            </button>
...
const botones =
    opcionesDiv.querySelectorAll("button");
...
if (!operario) {
    ...
    alert(
        "Ingrese nombre y legajo del operario."
    );
...
const resultadoGeneral =
    Object.values(respuestas).includes("NO OK")
        ? "NO OK"
        : "OK";
